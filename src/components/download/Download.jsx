          ...
          <div className="right-container">
            <div className="right1-container">
              <div className="right1-wrapper">
                <h5>
                  Report <span className="weak">for</span> Vladmirir Putin
                </h5>
              </div>
              <div className="right2-wrapper">
                <button>Email</button>
                <button>Download as PDF</button>
                <button>Download as PPT</button>
              </div>
            </div>
            ...
            <div className="right-modal">
              <div className="modal1">
                ...
                <div className="modal1-div1-p">
                  <p>
                    ...
                    (Travel ban), annexe 8; Justification for Sanctions:
                    Vladimir Putin is the President of the Russian Federation. ;
                    On 22 Feb 2022, he signed a decree recognising the
                    "independence and sovereignty" of the
                    non-government-controlled areas of the Donetsk and Luhansk
              ...
              <div className="modal2">
                ...
                <div className="modal2-flex">
                  ...
                  <div>
                    <p>
                      Vladimir Putin President Of Russia 2nd President of
                      Russian Federation
                    </p>
                  </div>
                </div>
                ...
                <table class="table table-hover">
                  ...
                  <tbody className="table-body">
                    ...
                    <tr>
                      ...
                      <td>Official Government Website</td>
                      <td>
                        Vladimir Vladimirovich Putin is a Politician in
                        Russia.His career roles are
                      </td>
                      <td>Read More</td>
                    </tr>
                    <tr>
              ...
              <div className="row">
                ...
                <div className="before-footer-bottomBorder ps-3 pe-3">
                  <p>
                    ...
                    SciencesSchool 281, Saint Petersburg State University,
                    School 193, Academy of Foreign Intelligence, Saint
                    Petersburg Mining University, St. Petersburg Institute of
                    the FSB of Russia, Faculty of Law, Saint Petersburg State
                    University, FSB Academy
                  </p>
                </div>
              </div>
              <div className="row">
                ...
                <div className="before-footer-bottomBorder ps-3 pe-3">
                  <p>
                    ...
                    lieutenant colonel and returned to Russia to become
                    prorector of Leningrad State University with responsibility
                    for the institution’s external relations. Soon afterward
                    Putin became an adviser to Sobchak, the first democratically
                    elected mayor of St. Petersburg. He quickly won Sobchak’s
                    confidence and became known for his ability to get things
                    done; by 1994 he had risen to the post of first deputy
                    mayor.;BRITANNICA QUIZ;History: Fact or Fiction?;Get hooked
                    on history as this quiz sorts out the past. Find out who
                    really invented movable type, who Winston Churchill called
                    "Mum," and when the first sonic boom was heard.;In 1996
                    Putin moved to Moscow, where he joined the presidential
                    staff as deputy to Pavel Borodin, the Kremlin’s chief
                    administrator. Putin grew close to fellow Leningrader
                    Anatoly Chubais and moved up in administrative positions. In
                    July 1998 Pres. Boris Yeltsin made Putin director of the
                    Federal Security Service (FSB; the KGB’s domestic
                    successor), and shortly thereafter he became secretary of
                    the influential Security Council. Yeltsin, who was searching
                    for an heir to assume his mantle, appointed Putin prime
                    minister in 1999.;Although he was virtually unknown, Putin’s
                    public-approval ratings soared when he launched a
                    well-organized military operation against secessionist
                    rebels in Chechnya. Wearied by years of Yeltsin’s erratic
                    behaviour, the Russian public appreciated Putin’s coolness
                    and decisiveness under pressure. Putin’s support for a new
                    electoral bloc, Unity, ensured its success in the December
                    parliamentary elections.;Get a Britannica Premium
                    ...
                    of the Council of CIS Heads of StateChairman of the Council
                    of CIS Heads of StatePresident of the Russian
                    Federationparty leaderPrime Minister of Russia Leader of
                    United Russia, Director of the Federal Security
                    Service,Political Career: After earning a law degree,
                    Putin's career in politics began with a 16 year stint
                    serving in the KGB. He trained at the 401st KGB school in
                    Okhta, Leningrad. After working monitoring foreigners and
                    consular officials in Leningrad, he was sent to Moscow for
                    further training at the Yuri Andropov Red Banner Institute
                    in 1984. Following that, under the cover identity of a
                    translator, he served in Dresden, East Germany from 1985 to
                    1990. He relocated to Leningrad after the collapse of the
                    Communist East German government, reconnecting with Anatoly
                    Sobchak while at his post at the International Affairs
                    section of Leningrad State University. Putin claims that on
                    the second day of the 1991 coup attempt against
                    then-President Mikhail Gorbachev, he resigned from the KGB
                    because he did not agree with what had happened and no
                    longer wished to be part of the intelligence operation of
                    the new post-coup administration.Sobchak, his former
                    professor, soon became the Mayor of Leningrad, and Putin was
                    appointed as head of the Committee for External Relations of
                    the Mayor's Office. From there, he continued to build his
                    political career through various political and governmental
                    positions. In July 1998, then-President Boris Yeltsin
                    appointed Putin as Director of the Federal Security Service
                    (FSB), which is the successor to the KGB and the primary
                    intelligence and security organization of the Russian
                    Federation.He was appointed acting Prime Minister of the
                    Government of the Russian Federation by Yeltsin on August 9,
                    1999, and later that day Putin agreed to run for the
                    presidency after Yeltsin stated his desire to see Putin as
                    his successor. His first Presidential term lasted from 2000
                    – 2008. Putin was also Prime Minister of Russia from 1999 –
                    2000 and again from 2008 – 2012. Over the years Putin has
                    earned a very controversial reputation. He is frequently
                    ...
                    since taking over as President in 1999 following the
                    surprise resignation of Boris Yeltsin.(Photo by Peter Muhly
